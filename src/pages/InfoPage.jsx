...
const InfoPage = ({state, onChange}) => {
    ...
    return (
        <div>
            ...
            {isInstruction && <div>
                <div className='info'>Данные, которые ты получила сообщать кому-то ЗАПРЕЩЕНО.Тебе предстоит выполнить несколько заданий, они не сложные. Все ответы необходимо
